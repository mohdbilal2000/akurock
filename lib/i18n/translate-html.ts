...
const HTML_REPLACEMENTS: [string, TranslationKey][] = [
  ...
  // ===== Installation guide + product page (auto-added; run early) =====
  ['Akustikpaneele montieren: Bist du bereit für dein erstes Projekt?', 'ig.h1'],
  ['Folge dieser Schritt-für-Schritt-Anleitung und montiere deine AKUROCK Naturstein-Akustikpaneele im Handumdrehen – ganz ohne Fachkenntnisse.', 'ig.intro'],
  ['Schritt 1: Werkzeuge und Materialien für die Paneel-Montage bereitlegen', 'ig.t1'],
  ['Schritt 2: Wand für die Wandverkleidung vorbereiten', 'ig.t2'],
  ['Schritt 3: Wandmaße nehmen und Akustikpaneele planen', 'ig.t3'],
  ['Schritt 4: Akurock Akustikpaneele an der Wand befestigen', 'ig.t4'],
  ['Schritt 5: Breite der Akurock Lamellenwand-Paneele anpassen', 'ig.t5'],
  ['Schritt 6: Akurock Akustikpaneele in der Länge kürzen', 'ig.t6'],
  ['Schritt 7: Aussparungen für Steckdosen in den Akustikpaneelen', 'ig.t7'],
  ['>Werkzeuge<', 'ig.l_tools'],
  ['>Messen<', 'ig.l_measure'],
  ['>Befestigung<', 'ig.l_mount'],
  ['>Anpassung<', 'ig.l_adjust'],
  ['>Zuschneiden<', 'ig.l_cut'],
  ['>Ausschnitte<', 'ig.l_cutouts'],
  ['>Abschluss<', 'ig.l_finish'],
  ['Bevor du mit der Montage deiner AKUROCK Akustikpaneele beginnst, stelle sicher, dass du die folgenden Werkzeuge und Materialien zur Hand hast:', 'ig.b_step1'],
  ['>Ein Maßband<', 'ig.li_tape'],
  ['>Einen Stift zum Markieren<', 'ig.li_pen'],
  ['<strong>Passende</strong> <strong>Schrauben</strong> oder <strong>Kleber</strong> zur Befestigung an der Wand.', 'ig.li_screws'],
  ['Einen Akkuschrauber oder Schraubendreher.', 'ig.li_driver'],
  ['Eventuell eine Säge falls gekürzt werden muss.', 'ig.li_saw'],
  ['Sollte dir etwas fehlen, findest du das passende Zubehör in unserem Shop.', 'ig.b_missing'],
  ['>Zubehör erkunden<', 'ig.btn_explore'],
  ['Reinige die Wand gründlich und entferne alle Hindernisse wie Schrauben oder Nägel. Stelle sicher, dass die Oberfläche glatt und eben ist – so hält deine Naturstein-Wandverkleidung optimal.', 'ig.b_step2'],
  ['Miss deine Wand sorgfältig aus, damit die Lamellenwand-Paneele perfekt passen. Schneide sie bei Bedarf auf die richtige Größe zu.', 'ig.b_step3'],
  ['Befestige deine AKUROCK Akustikpaneele entweder mit Schrauben oder Kleber an der Wand – beide Methoden sorgen für sicheren Halt.', 'ig.b_step4'],
  ['>Mit Schrauben:<', 'ig.h_screws'],
  ['Verwende die 40mm langen Schrauben und befestige die Paneele durch das Akustikfilz an der Wand. Bei massiven Wänden empfehlen wir die Verwendung von handelsüblichen Dübeln. Verwende ca. 15 Schrauben pro Paneel für eine sichere Befestigung.', 'ig.b_screws'],
  ['>Mit Kleber:<', 'ig.h_glue'],
  ['Trage den Montagekleber in wellenförmigen Linien auf die Rückseite der Paneele auf und drücke sie fest an die Wand.', 'ig.b_glue'],
  ['Um die Akurock Akustikpaneele in der Breite zu kürzen, brauchst du nichts weiter als ein Cutter-Messer – einfach und präzise.', 'ig.b_step5'],
  ['(wenn notwendig)', 'ig.ifnec'],
  ['Schneide die Akustikpaneele nach Bedarf auf die gewünschte Länge zu.', 'ig.b_step6'],
  ['Stelle sicher, dass die Enden der Leisten sicher mit 15mm langen Schrauben befestigt werden, um Stabilität zu gewährleisten.', 'ig.b_step6b'],
  ['Falls Steckdosen vorhanden sind, schneide die Paneele entsprechend aus, um Platz dafür zu schaffen. Am einfachsten gelingt das mit einer Stichsäge.', 'ig.b_step7'],
  ['Fertig: Zurücklehnen und bessere Raumakustik genießen', 'ig.t_done'],
  ['Nach der erfolgreichen Montage deiner AKUROCK Akustikpaneele ist es Zeit, dein neues Raumgefühl zu genießen. Lehn dich zurück und entspanne dich in der stilvollen und ruhigen Atmosphäre, die durch die Kombination von Naturstein-Wandverkleidung und effektiver Schallabsorption entsteht.', 'ig.b_done'],
  ['Voilá, du hast dein erstes DIY Projekt erfolgreich umgesetzt.', 'ig.b_voila'],
  ['>Jetzt Shoppen<', 'ig.btn_shop'],
  ['<strong>Das Akurock-Akustikpaneel von stonearts®</strong> ist ein in Österreich entworfenes, handgefertigtes Produkt mit einer 100% natürlichen Steinoberfläche. Es zeichnet sich nicht nur durch hervorragende Schallabsorption aus, sondern ist auch <strong>umweltfreundlich, da es upcycelten Akustikfilz verwendet.</strong>', 'prod.sustParagraph'],
  ['Holz aus nachhaltiger Forstwirtschaft', 'prod.sustWood'],
